    ...
    <body class="bg-dark">
                    ...
                    <form action="#" method="post" role ="form" class="p-2" id="formRegistro">
                        ...
                        <div class="form-group">
                            <input type="submit" name="btnRegistroUsuario" id="btnRegistroUsuario"
                                   value="::Registrar::" class="btn btn-primary btn-block">
        ...
        <script>
            ...
            $(function () {
                ...
                //Mostra caixa de Login no registro
                $("#btnEntrarRegistrar").click(function () {
                    $("#caixaLogin").show();//Mostrar
                ...
                //Fim do Ajax registro de usuario
